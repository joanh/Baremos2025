#!/usr/bin/env python3
"""
Visualizador Orientación Educativa (018) - Baremo 2025
...
def cargar_puntuaciones():
    ...
    try:
        ruta_csv = "../output/puntuaciones_orientacion_educativa_018.csv"
        puntuaciones = []
...
def main():
    print("🎨 VISUALIZADOR ORIENTACIÓN EDUCATIVA (018) - BAREMO 2025")
    print("=" * 50)
    ...
    fig.suptitle('Baremo Orientación Educativa 2025 - Comunidad de Madrid', 
    ...
    # Guardar gráficos
    output_path_1 = '../output/baremo_orientacion_educativa_018_2025.png'
    output_path_2 = '../../../img/baremo_orientacion_educativa_018_2025.png'
