#!/usr/bin/env python3
"""
Visualizador Biología y Geología (008) - Baremo 2025
...
def cargar_puntuaciones():
    ...
    try:
        ruta_csv = "../output/puntuaciones_biologia_geologia_008.csv"
        puntuaciones = []
...
def main():
    print("🎨 VISUALIZADOR BIOLOGÍA Y GEOLOGÍA (008) - BAREMO 2025")
    print("=" * 50)
    ...
    fig.suptitle('Baremo Biología y Geología 2025 - Comunidad de Madrid', 
    ...
    # Guardar gráficos
    output_path_1 = '../output/baremo_biologia_geologia_008_2025.png'
    output_path_2 = '../../../img/baremo_biologia_geologia_008_2025.png'
