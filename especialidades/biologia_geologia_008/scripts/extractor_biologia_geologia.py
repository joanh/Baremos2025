#!/usr/bin/env python3
"""
Extractor Biología y Geología (008) - Baremo 2025
Procesa páginas 1063-1245 del PDF oficial
"""
        ...
        with pdfplumber.open(pdf_path) as pdf:
            for i, num_pagina in enumerate(range(pagina_inicio, pagina_final + 1)):
                ...
                if num_pagina <= len(pdf.pages):
                    ...
                    # Buscar líneas de candidatos de BIOLOGIA Y GEOLOGIA específicamente
                    lineas = texto.split('\n')
                    for linea in lineas:
...
def guardar_resultados(puntuaciones, config):
    ...
    with open(txt_path, 'w', encoding='utf-8') as f:
        f.write("=== PUNTUACIONES BIOLOGÍA Y GEOLOGÍA (008) - 2025 ===\n\n")
        for i, puntuacion in enumerate(puntuaciones, 1):
    ...
    with open(python_path, 'w', encoding='utf-8') as f:
        ...
        f.write('"""\nPuntuaciones Biología y Geología (008) - Baremo 2025\n"""\n\n')
        f.write("puntuaciones_biologia_geologia_008 = [\n")
    ...
    with open(estadisticas_path, 'w', encoding='utf-8') as f:
        f.write("=== ESTADÍSTICAS BIOLOGÍA Y GEOLOGÍA (008) - 2025 ===\n\n")
...
def main():
    print("⚙️ EXTRACTOR BIOLOGÍA Y GEOLOGÍA (008) - BAREMO 2025")
    print("=" * 50)
