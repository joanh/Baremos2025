#!/usr/bin/env python3
"""
Visualizador Tecnología (019) - Baremo 2025
...
def cargar_puntuaciones():
    ...
    try:
        ruta_csv = "../output/puntuaciones_tecnologia_019.csv"
        puntuaciones = []
...
def main():
    print("🎨 VISUALIZADOR TECNOLOGÍA (019) - BAREMO 2025")
    print("=" * 50)
    ...
    fig.suptitle('Baremo Tecnología 2025 - Comunidad de Madrid', 
    ...
    # Guardar gráficos
    output_path_1 = '../output/baremo_tecnologia_019_2025.png'
    output_path_2 = '../../../img/baremo_tecnologia_019_2025.png'
