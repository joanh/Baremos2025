#!/usr/bin/env python3
"""
Extractor de Baremos - Física y Química 007
...
def main():
    """Función principal"""
    print("🔧 Iniciando extractor de Física y Química 007...")
    ...
    with open(lista_path, 'w', encoding='utf-8') as f:
        f.write("# Puntuaciones de Física y Química (007) - Baremo 2025\n")
    ...
    with open(stats_path, 'w', encoding='utf-8') as f:
        f.write(f"=== ESTADÍSTICAS FÍSICA Y QUÍMICA (007) - 2025 ===\n")
