#!/usr/bin/env python3
"""
Visualizador de puntuaciones para Geografía e Historia (005) - Baremos 2025
...
def crear_visualizacion():
    ...
    print(f"🗺️ Generando visualización para Geografía e Historia (005)")
    ...
    fig.suptitle('Baremo Geografía e Historia 2025 - Comunidad de Madrid', 
    ...
    # Guardar gráficos
    output_path_1 = '../output/baremo_geografia_e_historia_005_2025.png'
    output_path_2 = '../../../img/baremo_geografia_e_historia_005_2025.png'
