#!/usr/bin/env python3
"""
Extractor de Baremos - Matemáticas 008 (CORREGIDO FINAL)
Basado en el extractor exitoso de Informática 107
...
def extraer_puntuacion_total(linea):
    ...
    MÉTODO EXACTO del extractor exitoso de Informática
    """
...
def main():
    """Función principal"""
    print("🔧 Iniciando extractor CORREGIDO FINAL de Matemáticas 008...")
            ...
            for num_pagina in range(pdf_config['pagina_inicio'], pdf_config['pagina_fin'] + 1):
                try:
                    ...
                    if page_index < len(pdf.pages):
                        ...
                        if texto:
                            # Limpiar caracteres problemáticos (como en Informática)
                            for char in ['€', '‚', 'Ç', '§']:
